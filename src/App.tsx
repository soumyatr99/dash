...
const LoginPage = ({ onLogin }: { onLogin: (username: string) => void }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Assuming Column 1: Username, Column 2: Password
      // Skip header if exists (checking if first row looks like header)
      const dataRows = rows[0][0].toLowerCase().includes('user') ? rows.slice(1) : rows;
...
const DaysStrip = () => {
  ...
  return (
    <div className="grid grid-cols-3 gap-4 xl:gap-8 2xl:gap-16 mb-6 xl:mb-10 2xl:mb-20">
...
const AlertRow = () => (
  <div className="grid grid-cols-3 gap-4 xl:gap-8 2xl:gap-16 mt-6 xl:mt-10 2xl:mt-20">
...
const RMZones = () => (
  <div className="glass p-6 xl:p-10 2xl:p-20 rounded-2xl 2xl:rounded-[4rem] mt-6 xl:mt-10 2xl:mt-20">
    ...
    <div className="grid grid-cols-5 gap-4 xl:gap-8 2xl:gap-16">
      {RM_DATA.map((rm) => (
...
export default function App() {
  ...
  useEffect(() => {
    const savedLogin = localStorage.getItem('okcl_logged_in');
    const savedUser = localStorage.getItem('okcl_user');
  ...
  return (
    <div className={cn(
      "flex h-screen w-screen bg-[#05070a] overflow-hidden font-sans selection:bg-blue-500/30 transition-all duration-700",
      isTvMode ? "p-0" : "p-0"
    )}>
      {/* Sidebar - Hidden in TV Mode if we want true fullscreen dashboard */}
      {!isTvMode && (
      ...
      <main className="flex-1 flex flex-col relative min-h-0">
        {/* Header */}
        <header className={cn(
          "h-20 xl:h-24 2xl:h-48 px-6 xl:px-12 2xl:px-24 flex items-center justify-between z-40 border-b border-white/5 bg-[#05070a]/80 backdrop-blur-md transition-all",
          ...
          <div className="flex items-center gap-4 xl:gap-8 2xl:gap-16">
            ...
            <div className="flex flex-col">
              <h1 className="text-xl xl:text-2xl 2xl:text-6xl font-black tracking-tighter text-white uppercase">
              ...
              <div className="flex items-center gap-2 xl:gap-4 2xl:gap-8 mt-0.5 xl:mt-1 2xl:mt-4">
                ...
                <span className="flex items-center gap-1 xl:gap-2 2xl:gap-4 text-[10px] xl:text-xs 2xl:text-2xl text-blue-400 font-bold uppercase tracking-widest">
                  <User className="w-3 h-3 xl:w-4 xl:h-4 2xl:w-8 2xl:h-8" /> {user || 'Guest'}
                </span>
              </div>
            </div>
          </div>
          ...
          <AnimatePresence mode="wait">
            {activeSection === 0 && (
              ...
              >
                ...
                <div className="grid grid-cols-7 gap-4 xl:gap-6 2xl:gap-12 mb-6 xl:mb-10 2xl:mb-20">
                ...
                <div className="grid grid-cols-12 gap-6 xl:gap-8 2xl:gap-16 flex-1 min-h-0">
                  <div className="col-span-8 glass p-6 xl:p-10 2xl:p-20 rounded-2xl 2xl:rounded-[4rem] flex flex-col min-h-0">
                    <div className="flex justify-between items-center mb-6 xl:mb-10 2xl:mb-20">
                      <div>
                  ...
                  <div className="col-span-4 flex flex-col gap-6 xl:gap-8 2xl:gap-16">
            ...
            {activeSection === 1 && (
              ...
              >
                ...
                <div className="grid grid-cols-12 gap-6 xl:gap-10 2xl:gap-20 flex-1 min-h-0">
                  <div className="col-span-12 glass rounded-2xl xl:rounded-[4rem] overflow-hidden flex flex-col min-h-0">
